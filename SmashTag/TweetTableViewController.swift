...
//  SmashTag
//
//  Created by web corridor on 27/05/1938 Saka.
...
class TweetTableViewController: UITableViewController {
    var chapter = ["Ch 01","Ch 02","Ch 03","Ch 04","Ch 05","Ch 06","Ch 07","Ch 08"]
    ...
    */
    ...
    let blogSegueIdentifier = "ChapterNumber"
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        {
            //print(blogIndex)
            destination.blogName = String(blogIndex) //chapter[blogIndex]
        }
    }
